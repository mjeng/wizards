...
def solve(num_wizards, num_constraints, wizards, constraints):
    ...
    def convert_from_pair(w1, w2):
        return w1 + w2 * num_wizards
    def convert_to_pair(num):
        return [num % num_wizards, (num // num_wizards) % num_wizards]
    ...
    # convert = PairToIndex(ws[0], ws[2], num_wizards)
        ...
        cond1 = convert_from_pair(ws[0], ws[2])
        cond2 = convert_from_pair(ws[1], ws[2])
        cond3 = convert_from_pair(ws[2], ws[0])
        cond4 = convert_from_pair(ws[2], ws[1])
        cnf.append([cond1, cond2])
        cnf.append([-cond1, -cond2])
        cnf.append([cond3, cond3])
